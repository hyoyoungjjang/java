...
public class B_String {
	...
	public void method01() {
		...
		//String글래스에 hashCode메소드 이미 오버라이딩 되어있다. (주소값이 아닌 문자열을 가지고 나타낸다)
		
		// 주소값에 대한 해시코드가 알고 싶다면 System.identityHashCode메소드를 이용해야한다.
		...
		String str3 = "hello";
		String str4 = "hello";
		// 리처럴 제시시 상수풀(String Pool)영역에 올라감
...
//		char ch = new java.util.Scanner(System.in).next().toUpperCase().charAt(0); // 'N' 'Y'
	...
	public void method03() {
		...
		// 방법1 . 분리된 문자열들 String[] 배열에 차곡차곡 담고자 할때
