 ...
 *  - ClassCastExeption : 허용할 수 없는 형변환이 진행될때 발생되는 예외
...
//			int result = 0; //사용자가 두번째 정수를 0 으로 입력하는 순간 0으로 나누기가 진행되면서 예외 발생 => 프로그램 종료
//			if(num2 != 0) {
//				 result = num1 /num2;
//			}
			
			/*
			 * 예외처리 : "예외"가 발생했을 경우에 대해서 처리하는 방법을 예외처리
			 * try{
			 * 		예외가 발생할 수 있는 구문;
			...
			try {
				...
				e.printStackTrace(); // 강제로 오류난 이력보고자 할때 싱행하는 구문
			}
		...
		public void method02() {
			...
			System.out.println("100 번째 인덱스값 : " + arr[100]);
			} catch(ArrayIndexOutOfBoundsException e) {
				System.out.println("부적잘한 인덱스로 접근했습니다.");
