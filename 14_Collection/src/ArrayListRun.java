...
public class ArrayListRun {
	...
	public static void main(String[] args) {
		...
		//3. remove(int index) : 해당 인덱스 위치에 데이터를 삭제시켜주는 메소드
		list.remove(1);
		System.out.println(list);
...
//		System.out.println(s);
		...
		//8. addAll(Collection c) : 컬렉션을 토ㅗㅇ채로 뒤에 추가시켜주는 메소드
		list.addAll(sub);
		System.out.println(list);
